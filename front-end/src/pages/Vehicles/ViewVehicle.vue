  ...
  <div class="content">
    ...
    <div class="md-layout md-layout-button margin">
      <md-menu md-size="big" md-direction="top-start">
        <md-button @click="backButton" class="md-danger md-raised toggle"
          ...
          <md-card-content class="md-layout md-alignment-center">
            <template>
              <div class="md-layout-item md-small-size-100 md-size-33 border">
                <h5 class="text-danger">Informações de modelo</h5>
                <p class="text-muted">
              ...
              <div class="md-layout-item md-small-size-100 md-size-33 border">
                <h5 class="text-danger">Informações cruciais</h5>
                <p>
              ...
              <div class="md-layout-item md-small-size-100 md-size-33">
                <h5 class="text-danger">Imprimir documentos</h5>
                <div>
                  <md-button
      ...
      >
        <md-card class="md-card-plain">
          ...
          <md-card-content v-else class="md-layout md-alignment-center">
            <template>
              <div class="md-layout-item md-small-size-100 md-size-33 border">
                <h5 class="text-danger">Galaxy Pay</h5>
              </div>
              <div class="md-layout-item md-small-size-100 md-size-33 border">
                <h5 class="text-danger">Status gerais</h5>
                <p>
